...
Please contact the patient to confirm the appointment.`;
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg sm:rounded-xl border transition-all duration-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                      darkMode
  ...
  <div>
    ...
    <select
      ...
      onChange={handleInputChange}
      required
      className={`w-full h-14 px-4 text-sm rounded-2xl border transition-all duration-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
        darkMode
